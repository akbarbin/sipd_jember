...
class Tabular_general extends Admin_Controller {
  ...
  public function index() {
    ...
    if ($this->form_validation->run('search_tabular')) {
      ...
      $this->data['title'] = 'Data Umum Instansi ' . $sub_district[0]->name . ' Tahun ' . $post['year'];
    } else {
      $this->data['title'] = 'Data Umum Instansi';
    }
  ...
  public function view() {
    ...
    $this->data['title'] = 'Data Umum ' . $tabular[0]->name . ' Instansi ' . $sub_district[0]->name . ' Tahun ' . $tabular[0]->year;
    $this->load->view('layout/admin', $this->data);
  }
  ...
  public function export_excel() {
    ...
    $this->load->model('Sub_district_model');
    $sub_district = $this->Sub_district_model->get_all(array('id' => $tabular[0]->sub_district_id));
    $title = 'Data Umum ' . $tabular[0]->name . ' Instansi ' . $sub_district[0]->name . ' Tahun ' . $tabular[0]->year;
