...
echo form_open('admin/unit/edit/'.$id, array('class' => 'form-horizontal'));
echo bootstrap_form_input('name', $unit->name, array('class' => 'span6', 'placeholder' => 'Nama', 'label' => 'Nama' . bootstrap_text_important()));
echo bootstrap_form_textarea('description', $unit->description, array('class' => 'span8', 'rows' => 6, 'label' => 'Keterangan'));
