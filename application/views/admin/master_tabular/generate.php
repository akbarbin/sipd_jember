...
echo form_open('admin/master_tabular/generate', array('class' => 'form-horizontal'));
...
echo bootstrap_form_submit(NULL, 'Generate', array('class' => 'btn btn-primary', 'after' => anchor('admin/master_tabular', 'Kembali', 'class="btn btn-danger btn-link-bootstrap"')));
echo form_close();
?>