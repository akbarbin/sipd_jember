...
foreach ($master_tabulars as $key => $master_tabular) {
  ...
  echo bootstrap_tag('td', bootstrap_tag('span', $master_tabular->ref_code, array('class' => 'tree-span', 'style' => 'padding-left:' . (($master_tabular->ancestry_depth - $ancestry_depth) * 30) . 'px;')) . bootstrap_tag('span', $master_tabular->name, array('class' => 'text-overflow')));
