...
echo form_open('admin/master_tabular_criteria/edit/'.$id, array('class' => 'form-horizontal'));
echo bootstrap_form_input('name', $master_tabular->name, array('class' => 'span6', 'placeholder' => 'Nama Kriteria', 'label' => 'Nama Kriteria' . bootstrap_text_important()));
