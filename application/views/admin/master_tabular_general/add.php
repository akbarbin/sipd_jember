...
echo form_open('admin/master_tabular_general/add', array('class' => 'form-horizontal'));
echo form_hidden('parent_id', $parent_id, 'readonly = "readonly"');
echo bootstrap_form_input('name', NULL, array('class' => 'span6', 'placeholder' => 'Nama Data umum', 'label' => 'Nama Data Umum' . bootstrap_text_important()));
