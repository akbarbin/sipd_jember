...
echo form_open('admin/profile/add', array('class' => 'form-horizontal'));
echo bootstrap_form_input('slug', NULL, array('class' => 'span6', 'placeholder' => 'URL', 'label' => 'URL' . bootstrap_text_important()));
echo bootstrap_form_input('title', NULL, array('class' => 'span6', 'placeholder' => 'Judul', 'label' => 'Judul' . bootstrap_text_important()));
echo bootstrap_form_textarea('content', NULL, array('class' => 'span8', 'rows' => 6, 'label' => 'Isi Profile'));
