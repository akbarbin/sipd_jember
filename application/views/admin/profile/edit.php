...
echo form_open('admin/profile/edit/'.$id, array('class' => 'form-horizontal'));
echo bootstrap_form_input('title', $profile->title, array('class' => 'span6', 'placeholder' => 'Judul', 'label' => 'Judul' . bootstrap_text_important()));
echo bootstrap_form_textarea('content', $profile->content, array('class' => 'span8', 'rows' => 6, 'label' => 'Isi Profile'));
