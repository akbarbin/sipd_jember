...
echo form_open('admin/user/edit/'.$id, array('class' => 'form-horizontal'));
echo bootstrap_form_input('name', $user->name, array('class' => 'span6', 'placeholder' => 'Nama', 'label' => 'Nama' . bootstrap_text_important()));
...
echo bootstrap_form_dropdown('sub_district_id', array($user->sub_district_id), array('class' => 'span6', 'list' => $sub_district_list, 'label' => 'Kecamatan' . bootstrap_text_important()));
