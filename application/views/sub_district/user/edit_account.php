...
echo form_open('sub_district/user/edit_account', array('class' => 'form-horizontal'));
...
echo bootstrap_form_submit(NULL, 'Simpan', array('class' => 'btn btn-primary', 'after' => anchor('sub_district/user', 'Kembali', 'class="btn btn-danger btn-link-bootstrap"')));
echo form_close();
?>